...
return {
	...
	update = function(self, dt)
		...
		if not graphics.isFading() then
			...
			if input:pressed("down") or downPressed then
				...
				menuFunc()
			elseif input:pressed("up") or upPressed then
				audio.playSound(selectSound)
				...
				menuFunc()
			elseif input:pressed("left") or leftPressed then
				audio.playSound(selectSound)
			...
			elseif input:pressed("right") or rightPressed then
				audio.playSound(selectSound)
			...
			elseif input:pressed("confirm") or enterPressed then
